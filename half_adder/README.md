...
17.  Type in terminal  vlib  <name_you_want_to_give_to_your_work_library>      (this is necessary, recommended to give the name of your project i.e. <half_adder_lib>)
...
27.  For example  :    vsim -c -voptargs=+acc half_adder_lib.half_adder_tb
